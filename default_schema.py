...
TARGET_COLUMNS = [
    ...
    "ClientNo", "ZoneInfoId", "IsActive", "InactiveDate",
...
def sop_default_rules():
    ...
    batch("ZoneInfoId", note="SOP: one fixed Id per pourashava from the 'ZoneInfoId' reference file. CONFIRMED for Durgapur = 145 (cross-checked from both Durgapur-Ward.xlsx and Durgapur-Street.xlsx, ZoneInfoId column is 145 on every row of both). Pre-filled, but verify it's still current before shipping.")
    r["ZoneInfoId"].value = "145"
