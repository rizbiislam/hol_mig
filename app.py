...
-----------------------------
Rule-driven migration tool built from the actual Instruction_for_master_data
SOP, not a generic column-renamer. See rule_engine.py for the rule
vocabulary and default_schema.py for the SOP-derived starting template.
"""
